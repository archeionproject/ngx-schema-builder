...
It omits Tailwind's preflight, so it will not reset your app; the editor's theming is scoped under the `.jsonjoy` class that every component applies automatically.
